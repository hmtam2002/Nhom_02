...
namespace Nhom_02.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(Nhom2Context context)
        {
            _context = context;
        }
        ...
        {
            var nhom2Context = _context.Carts.Include(c => c.Account).Include(c => c.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Nhom2Context.Carts'  is null.");
            }
            var cart = await _context.Carts.FindAsync(id);
            if (cart != null)
            {
